...
sleep 10
echo "Creating DBs..."
mysql --socket=$BIND_SOCKET -uroot -e "CREATE DATABASE auf_projets;"
mysql --socket=$BIND_SOCKET -uroot -e "CREATE DATABASE ag_dev;"
mysql --socket=$BIND_SOCKET -uroot -e "CREATE DATABASE coda;"
echo "DBs created"
#mysql coda --socket=$BIND_SOCKET -uroot < coda.sql
